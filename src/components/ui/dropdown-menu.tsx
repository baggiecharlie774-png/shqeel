...
function DropdownMenuTrigger({
  ...
  if (!renderProp && asChild && React.isValidElement(children)) {
  ...
  return <MenuPrimitive.Trigger data-slot="dropdown-menu-trigger" render={renderProp} {...props}>{content}</MenuPrimitive.Trigger>
}
